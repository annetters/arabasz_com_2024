...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col p-8 md:p-16">
      <div className="max-w-2xl">
        <h1 className="m:text-3xl text-3xl font-bold tracking-tight text-slate-800 dark:text-slate-100">
        ...
        <div className="mt-6 flex gap-6">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
              className="h-6 w-6 fill-slate-500 transition group-hover:fill-slate-600 dark:fill-slate-400 dark:group-hover:fill-slate-300"
            >
